defmodule SymphonyElixir.StatusDashboard do
  ...
  defp humanize_codex_method("account/rateLimits/updated", _payload),
    do: "account telemetry ignored"

  defp humanize_codex_method("account/telemetry/ignored", _payload),
    do: "account telemetry ignored"
